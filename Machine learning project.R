#load packages & data
library(data.table)
train <- fread("/Users/mokshithreddy/Downloads/train-2.csv",na.strings = c(""," ","?","NA",NA))
test <- fread("/Users/mokshithreddy/Downloads/test-2.csv",na.strings = c(""," ","?","NA",NA))
